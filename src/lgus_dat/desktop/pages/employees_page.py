...
class EmployeesPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        emp_header = self.emp_table.horizontalHeader()
        emp_header.setSectionResizeMode(0, QHeaderView.ResizeToContents)
        emp_header.setSectionResizeMode(1, QHeaderView.Stretch)
        emp_header.setSectionResizeMode(2, QHeaderView.Stretch)
        emp_header.setSectionResizeMode(3, QHeaderView.Stretch)
        emp_header.setSectionResizeMode(4, QHeaderView.Stretch)
        emp_header.setStretchLastSection(True)
        emp_header.resizeSection(1, 100)
        emp_header.resizeSection(2, 120)
        emp_header.resizeSection(3, 120)
        emp_header.resizeSection(4, 400)
        ...
        dept_header = self.dept_table.horizontalHeader()
        dept_header.setSectionResizeMode(0, QHeaderView.ResizeToContents)
        dept_header.setSectionResizeMode(1, QHeaderView.Stretch)
        dept_header.setSectionResizeMode(2, QHeaderView.Stretch)
        dept_header.setSectionResizeMode(3, QHeaderView.Stretch)
        dept_header.resizeSection(1, 400)
        dept_header.resizeSection(2, 120)
        dept_header.resizeSection(3, 120)
